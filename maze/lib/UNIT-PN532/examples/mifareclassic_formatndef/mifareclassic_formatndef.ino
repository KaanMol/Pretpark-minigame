...
// If using the breakout with SPI, define the pins for SPI communication for ESP32.
#define PN532_SCK  (18)
...
//UNIT_PN532 nfc(PN532_SCK, PN532_MISO, PN532_MOSI, PN532_SS);
...
//UNIT_PN532 nfc(PN532_IRQ, PN532_RESET);
...
*/
// For a http://www. url:
const char * url = "uelectronics.com";
